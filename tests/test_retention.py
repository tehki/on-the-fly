...
`CODING_AGENT_POLICY_v1.2.yaml` lists the tests this module is required to have, under
...
def test_every_policy_required_test_exists_here() -> None:
    ...
    Adding a requirement to CODING_AGENT_POLICY_v1.2.yaml fails the build until a test
